...
tileImage = new Image();
tileImage.src = "data:image/gif;base64,R0lGODlhCAAIAMQAAAAAAP///wCc3gGc3gKc3g2e2xCf2xqh2Ruh2Cqk1S+l1Euqz1aszFitzJW4wCnm97G9urK+utDDtPrMqOjIr//Mqv3MqvzLq////wAAAAAAAAAAAAAAAAAAAAAAAAAAACH/C05FVFNDQVBFMi4wAwEAAAAh+QQFAAAYACwAAAAACAAIAAAFGWAljtVEnmhVnELVtm77PIIw1AKd1/S84yEAOw==";
app.TERRAIN_IMAGES["D"] = tileImage;

tileImage = new Image();
tileImage.src = "data:image/gif;base64,R0lGODlhCAAIAMQAAAAAAP///wCc3gGc3gOd3QSd3Qed3Que3BCf2zOm1Eep0Fyty3Cxxynm90fi7HXd3LS+ubfVxNPRusjCtd/GsfrMqP/Mqv7Mqv3MqvjLq/DJrfzLq////wAAAAAAAAAAACH/C05FVFNDQVBFMi4wAwEAAAAh+QQFAAAcACwAAAAACAAIAAAFHaAgNEhjWVUjDGcrDqYrGq0l1mejCvXeHC3dqBYCADs=";
app.TERRAIN_IMAGES["E"] = tileImage;

tileImage = new Image();
tileImage.src = "data:image/gif;base64,R0lGODlhCAAIAMQAAAAAAP///wCc3gGc3gWd3Qad3Q6f2w+f2xuh2Cqk1UOp0E+rzlitzGmwyYi2winm9yzm9rC9uuvOsfLOr+HGsO7JrefHr+XHr//Mqv7Mqv3MqvjLq////wAAAAAAAAAAACH/C05FVFNDQVBFMi4wAwEAAAAh+QQFAAAcACwAAAAACAAIAAAFFqAgPAP0PKOoqtjaClgrH3Ft37id5SEAOw==";
app.TERRAIN_IMAGES["F"] = tileImage;

tileImage = new Image();
tileImage.src = "data:image/gif;base64,R0lGODlhCAAIAMQAAAAAAP///wCc3gKc3gqe3BGf2xSg2hmh2TKl1Dam00yqz5O4wCnm92Pf4r7Uwb7At8HAt9rQt97QttvFsfnNrO/JrefHr//Mqv7Mqv3MqvvLq/rLq/HJrf///wAAAAAAACH/C05FVFNDQVBFMi4wAwEAAAAh+QQFAAAdACwAAAAACAAIAAAFGOCVXQJjCleqCqi6qhtbuiSDYqu5ym3KhwA7";
app.TERRAIN_IMAGES["G"] = tileImage;

tileImage = new Image();
tileImage.src = "data:image/gif;base64,R0lGODlhCAAIAMQAAAAAAP///wCc3gGc3gKc3hOg2h+i2Cik1l2uy2Guypy5vinm9yzm9i7l9TDl9Tfk8mLf4mne4Ira1K69u8TTv/LOr+nIrufHr//Mqv7MqvjLq/bKrPXKrP///wAAAAAAACH/C05FVFNDQVBFMi4wAwEAAAAh+QQFAAAdACwAAAAACAAIAAAFGCCGZWJpnqWwYEIqqK37iu+7xKy9ircdAgA7";
app.TERRAIN_IMAGES["H"] = tileImage;

tileImage = new Image();
tileImage.src = "data:image/gif;base64,R0lGODlhCAAIAMQAAAAAAP///wCc3gGc3gWd3Qie3BGf2xSg2i2k1Uuqz3ayxpi5vynm90Dj74Tb1qHXzMXBttTEs/rMqP/Mqv7MqvrLq/jLq/fKrP///wAAAAAAAAAAAAAAAAAAAAAAAAAAACH/C05FVFNDQVBFMi4wAwEAAAAh+QQFAAAYACwAAAAACAAIAAAFGOAkjqRIjcKUksLKrsIhMkzr1gJD0nkrhgA7";
app.TERRAIN_IMAGES["I"] = tileImage;

tileImage = new Image();
tileImage.src = "data:image/gif;base64,R0lGODlhCAAIAMQAAAAAAP///wCc3gGc3gSd3Qie3Aye3Cuk1Tmn0laszG6xyHGxxynm9yrm90Dj70Pj7k/h6cXTv9/QtfHOr9fEsuDGsP/Mqv7Mqv3MqvzMq/fKrP///wAAAAAAAAAAAAAAACH/C05FVFNDQVBFMi4wAwEAAAAh+QQFAAAbACwAAAAACAAIAAAFFyAjilYpCkxZoqlqsYygok27Wo+r73sIADs=";
app.TERRAIN_IMAGES["J"] = tileImage;

tileImage = new Image();
tileImage.src = "data:image/gif;base64,R0lGODlhCAAIAMQAAAAAAP///wCc3gKc3gOd3QSd3Rmh2Rqh2R2h2DOm1FGrzWiwyXmzxZ26vinm9y3l9bO+ubS+ud7Gse7Jrf/Mqv7Mqv3Mq/fKrP///wAAAAAAAAAAAAAAAAAAAAAAAAAAACH/C05FVFNDQVBFMi4wAwEAAAAh+QQFAAAYACwAAAAACAAIAAAFG+AlXoLjCKKgrqPJpqtAkaxQjShJ7aNY7bNRCAA7";
